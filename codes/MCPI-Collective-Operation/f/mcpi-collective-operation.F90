program mcpi
    ...
    real(kind=8):: x , y, time_s, time_e, pi, M_PI, count, val , one_over_rand_max, count_g
    ...
    call MPI_FIXME(FIXME,count_g,FIXME,MPI_DOUBLE_PRECISION,FIXME,FIXME,MPI_COMM_WORLD,ierr)

    if(irank==0) then
        pi=4.d0*FIXME/real(nn,kind=8)
