program subcommunicator
    ...
    ikey=1
    call MPI_COMM_SPLIT(MPI_COMM_WORLD,icolor,ikey,subcomm,ierr)
    call MPI_COMM_RANK(subcomm,irank_s,ierr)
    call MPI_COMM_SIZE(subcomm,nrank_s,ierr)
    ...
    call MPI_BCAST(irank_w_of_irank_s_equal_zero,1,MPI_INTEGER,0,subcomm,ierr)
