program subarray
    ...
    ind_subarray=[1,1]
    call MPI_TYPE_CREATE_SUBARRAY(2,FIXME,FIXME,FIXME,ind_subarray, &
        MPI_ORDER_FORTRAN,FIXME,type_subarray)
    call MPI_TYPE_COMMIT(FIXME)
    ...
    if(irank==0) then
        ...
        call MPI_SEND(array,FIXME,type_subarray,1,22,MPI_COMM_WORLD)
    else
        array=0
